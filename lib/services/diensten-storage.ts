...
const SYSTEM_DIENSTEN: Dienst[] = [
  { 
    ...
    code: '=', 
    naam: 'Vrij', 
    beschrijving: 'Vrij conform roosterplanning', 
    begintijd: '00:00',
    eindtijd: '00:00',
    duur: 0,
    kleur: '#47F906', 
  ...
  { 
    ...
    beschrijving: 'Medewerker niet beschikbaar op deze dag', 
    begintijd: '00:00',
    eindtijd: '00:00',
    duur: 0,
    kleur: '#FFF59D', 
  ...
  },
  {
    ...
    code: 'VRIJ',
    naam: 'Vrije dag',
    beschrijving: 'Geplande vrije dag',
    begintijd: '00:00',
    eindtijd: '00:00', 
    duur: 0,
    kleur: '#22c55e',
...
const DEFAULT_DIENSTEN: Dienst[] = [
  ...
  { 
    ...
    code: 'D24', 
    naam: '24-uurs dienst', 
    beschrijving: 'Continue 24-uurs bereikbaarheid', 
    begintijd: '08:00',
    eindtijd: '08:00',
    duur: 24,
    kleur: '#BE185D', 
  ...
  { 
    ...
    code: 'D', 
    naam: 'Dagdienst', 
    beschrijving: 'Reguliere dagdienst 08:00-16:00', 
    begintijd: '08:00',
    eindtijd: '16:00',
    duur: 8,
    kleur: '#10B981', 
  ...
  { 
    ...
    code: 'SP', 
    naam: 'Speciaal', 
    beschrijving: 'Speciale dienst op afroep', 
    begintijd: '09:00',
    eindtijd: '17:00',
    duur: 8,
    kleur: '#8B5CF6', 
  ...
  { 
    ...
    code: 'ECHO', 
    naam: 'Echo', 
    beschrijving: 'Echo onderzoek 13:00-17:00', 
    begintijd: '13:00',
    eindtijd: '17:00',
    duur: 4,
    kleur: '#F59E0B', 
  ...
  { 
    ...
    code: 'ND', 
    naam: 'Nachtdienst', 
    beschrijving: 'Nachtdienst 22:00-06:00', 
    begintijd: '22:00',
    eindtijd: '06:00',
    duur: 8,
    kleur: '#1F2937', 
  ...
  { 
    ...
    code: 'SS', 
    naam: 'Weekend', 
    beschrijving: 'Weekend dienst 08:00-20:00', 
    begintijd: '08:00',
    eindtijd: '20:00',
    duur: 12,
    kleur: '#EF4444', 
...
export function updateService(id: string, patch: Partial<Dienst>): Dienst {
  ...
  if (current.system) {
    // Systeemdiensten: alleen actief mag worden aangepast
  ...
  // Herbereken duur als tijden zijn gewijzigd
