            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 hover:bg-red-100 transition-colors">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3 sm:flex-row flex-col">
                  ...
                  <button onClick={()=>router.push(`/planning/design?rosterId=${rosterId}`)} className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 font-medium whitespace-nowrap">Openen →</button>
                </div>
              </div>
            </div>
