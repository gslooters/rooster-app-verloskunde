      ...
      <div className="max-w-6xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            ...
            <a href="/planning" className="bg-blue-50 p-6 rounded-xl hover:bg-blue-100 transition-all duration-300 cursor-pointer block shadow-sm hover:shadow-md"><div className="flex items-center mb-3"><span className="text-2xl mr-3">📋</span><h3 className="font-bold text-blue-900 text-lg">Rooster Ontwerpen</h3></div><p className="text-blue-700 font-medium">Nieuwe planning starten</p></a>
